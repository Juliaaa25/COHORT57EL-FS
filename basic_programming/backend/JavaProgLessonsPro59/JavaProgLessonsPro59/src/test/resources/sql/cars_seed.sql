...
VALUES ('BMW', 'X5', 2018, 78000, 28000,
        'SOLD', 'White', 265, 'DIESEL', 'AUTOMATIC');SERT INTO cars (    brand, model, production_year, mileage, price,    status, color, horsepower, fuel_type, transmission) VALUES (    'BMW', 'X5', 2018, 78000, 28000,    'USED', 'White', 265, 'DIESEL', 'AUTOMATIC');