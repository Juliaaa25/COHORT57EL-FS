...
public class CarController {
    ...
    @GetMapping("/by-fuel")
    public List<Car> getByFuelType(@RequestParam FuelType fuelType) {
        return carRepository.findByFuelType(fuelType);
    }

    @GetMapping("/by-color")
    public List<Car> findByColorIgnoreCase(@RequestParam String color) {
        return carRepository.findByColorIgnoreCase(color);
    }

    @GetMapping("/by-power")
    public List<Car> getByHorsepower(
            @RequestParam int minHp,
            @RequestParam int maxHp
    ) {
        return carRepository.findByHorsepowerBetween(minHp, maxHp);
    }
